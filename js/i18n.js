...
7/5-7/10 内测 高 @fafa`,
        ...
        // 完成编辑弹窗
        'action.title': '完成编辑',
        'action.subtitle': '请选择操作',
        'action.recordGithub': '从 GitHub 记录版本并解锁',
        'action.uploadNew': '上传新版本并解锁',
        'action.finishText': '结束占用',
        'action.noteLabel': '版本备注（可选）',
        'action.notePlaceholder': '这一版主要修改了哪些内容，方便成员快速了解',
        'action.discardTitle': '放弃修改',
        'action.discardConfirm': '确定要放弃所做的修改并解锁任务吗？这不会删除之前已上传的版本，只会放弃当前编辑周期内的修改。',
        'action.discardBtn': '放弃修改 (不保存)',
...
7/5-7/10 内部テスト 高 @fafa`,
        ...
        // 完成编辑弹窗
        'action.title': '編集を完了',
        'action.subtitle': '操作を選択してください',
        'action.recordGithub': 'GitHub からバージョン記録 & ロック解除',
        'action.uploadNew': '新バージョンをアップロード & ロック解除',
        'action.finishText': '占有終了',
        'action.noteLabel': 'バージョンメモ（任意）',
        'action.notePlaceholder': '今回の主な変更内容をメンバーに共有',
        'action.discardTitle': '変更を破棄',
        'action.discardConfirm': '変更を破棄してタスクのロックを解除しますか？既存バージョンは削除されず、今回の編集セッションの変更のみが破棄されます。',
        'action.discardBtn': '変更を破棄（保存しない）',
